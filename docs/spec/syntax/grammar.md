...
TYPE_EXPRESSION_GROUPING         ::= EXPRESSION_LAMBDA | '(' TYPE_EXPRESSION ')' | '{' EXPRESSION '}' | EXPRESSION_PATH | TYPE_EXPRESSION_LABEL | TYPE_EXPRESSION_SUGAR | TYPE_EXPRESSION_PRIMARY
...
```ebnf
EXPRESSION                ::= EXPRESSION_RETURN | KEYWORD_TYPE TYPE_EXPRESSION
