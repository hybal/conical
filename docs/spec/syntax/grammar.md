...
TYPE_IMPL_SUGAR                  ::= KEYWORD_IMPL '{' ITEM+ '}'
...
ITEM                  ::= (ATTRIBUTE)* ((ITEM_MODIFIERS (LET_BINDING | FUNCTION_DECLARATION | TYPE_DECLARATION)) | MOD_STATEMENT)

ITEM_MODIFIERS        ::= {LINKAGE}
...
MOD_STATEMENT         ::= KEYWORD_MOD EXPRESSION ';'
