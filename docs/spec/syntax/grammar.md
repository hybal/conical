...
TYPE_EXPRESSION_POSTFIX          ::= TYPE_EXPRESSION_GROUPING '(' { EXPRESSION ( ',' EXPRESSION )* {','}} ')'
...
TYPE_EXPRESSION_PRIMARY          ::= EXPRESSION_LITERAL
                                   | KEYWORD_SELF 
                                   | KEYWORD_TYPE
...
TYPE_INTERFACE_SUGAR             ::= KEYWORD_INTERFACE '{' INTERFACE_DECLARATION '}'

INTERFACE_DECLARATION            ::= KEYWORD_FN IDENTIFIER TYPE_LIST {TYPE_EXPRESSION} ';'
...
FUNCTION_DECLARATION ::= KEYWORD_FN IDENTIFIER FUNCTION_SIGNATURE ( ( '=>' ( EXPRESSION_BLOCK | EXPRESSION ';' ) ) | ';' )

FUNCTION_SIGNATURE   ::= PARAMETER_LIST {TYPE_EXPRESSION}

PARAMETER_LIST       ::= '(' { { BINDING_MODIFIER } IDENTIFIER ':' TYPE_EXPRESSION (',' IDENTIFIER ':' TYPE_EXPRESSION )* {','} } ')'
...
EXPRESSION_BLOCK          ::= ATTRIBUTE* '{' (STATEMENT)* '}'
...
EXPRESSION_LAMBDA         ::= '\\' LAMBDA_PARAMETER_LIST '=>' EXPRESSION_OPTIONAL_BLOCK

LAMBDA_PARAMETER_LIST     ::= {'$'} IDENTIFIER | ('(' { {'$'} IDENTIFIER { ':' TYPE_EXPRESSION } ( ',' {'$'} IDENTIFIER { ':' TYPE_EXPRESSION } )* {','} } ')') {TYPE_EXPRESSION}
...
ITEM                  ::= (ATTRIBUTE)* ( ( ITEM_MODIFIERS ( LET_BINDING | FUNCTION_DECLARATION ) ) | MOD_STATEMENT)
