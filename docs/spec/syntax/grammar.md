...
TYPE_EXPRESSION_GROUPING         ::= '(' TYPE_EXPRESSION ')' | '{' EXPRESSION '}' | EXPRESSION_PATH | TYPE_EXPRESSION_LABEL | TYPE_EXPRESSION_SUGAR | TYPE_EXPRESSION_PRIMARY
...
FUNCTION_CALL_ARGUMENT    ::= { '.' { IDENTIFIER | '$' IDENTIFIER } '=' } EXPRESSION
...
MODULE_DECLARATION    ::= KEYWORD_MOD EXPRESSION_PATH ';'
