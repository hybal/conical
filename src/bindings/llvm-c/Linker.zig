...
pub const LLVMLinkerDestroySource: c_int = 0;
pub const LLVMLinkerPreserveSource_Removed: c_int = 1;
pub const LLVMLinkerMode = c_uint;
pub extern fn LLVMLinkModules2(Dest: LLVMModuleRef, Src: LLVMModuleRef) LLVMBool;
