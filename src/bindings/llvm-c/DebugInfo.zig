...
pub const LLVMDWARFSourceLanguageHIP: c_int = 46;
pub const LLVMDWARFSourceLanguageAssembly: c_int = 47;
pub const LLVMDWARFSourceLanguageC_sharp: c_int = 48;
pub const LLVMDWARFSourceLanguageMojo: c_int = 49;
pub const LLVMDWARFSourceLanguageGLSL: c_int = 50;
pub const LLVMDWARFSourceLanguageGLSL_ES: c_int = 51;
pub const LLVMDWARFSourceLanguageHLSL: c_int = 52;
pub const LLVMDWARFSourceLanguageOpenCL_CPP: c_int = 53;
pub const LLVMDWARFSourceLanguageCPP_for_OpenCL: c_int = 54;
pub const LLVMDWARFSourceLanguageSYCL: c_int = 55;
pub const LLVMDWARFSourceLanguageRuby: c_int = 56;
pub const LLVMDWARFSourceLanguageMove: c_int = 57;
pub const LLVMDWARFSourceLanguageHylo: c_int = 58;
pub const LLVMDWARFSourceLanguageMips_Assembler: c_int = 59;
pub const LLVMDWARFSourceLanguageGOOGLE_RenderScript: c_int = 60;
pub const LLVMDWARFSourceLanguageBORLAND_Delphi: c_int = 61;
...
pub extern fn LLVMGetModuleDebugMetadataVersion(Module: LLVMModuleRef) c_uint;
pub extern fn LLVMStripModuleDebugInfo(Module: LLVMModuleRef) LLVMBool;
pub extern fn LLVMCreateDIBuilderDisallowUnresolved(M: LLVMModuleRef) LLVMDIBuilderRef;
pub extern fn LLVMCreateDIBuilder(M: LLVMModuleRef) LLVMDIBuilderRef;
pub extern fn LLVMDisposeDIBuilder(Builder: LLVMDIBuilderRef) void;
pub extern fn LLVMDIBuilderFinalize(Builder: LLVMDIBuilderRef) void;
pub extern fn LLVMDIBuilderFinalizeSubprogram(Builder: LLVMDIBuilderRef, Subprogram: LLVMMetadataRef) void;
pub extern fn LLVMDIBuilderCreateCompileUnit(Builder: LLVMDIBuilderRef, Lang: LLVMDWARFSourceLanguage, FileRef: LLVMMetadataRef, Producer: [*c]const u8, ProducerLen: usize, isOptimized: LLVMBool, Flags: [*c]const u8, FlagsLen: usize, RuntimeVer: c_uint, SplitName: [*c]const u8, SplitNameLen: usize, Kind: LLVMDWARFEmissionKind, DWOId: c_uint, SplitDebugInlining: LLVMBool, DebugInfoForProfiling: LLVMBool, SysRoot: [*c]const u8, SysRootLen: usize, SDK: [*c]const u8, SDKLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateFile(Builder: LLVMDIBuilderRef, Filename: [*c]const u8, FilenameLen: usize, Directory: [*c]const u8, DirectoryLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateModule(Builder: LLVMDIBuilderRef, ParentScope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, ConfigMacros: [*c]const u8, ConfigMacrosLen: usize, IncludePath: [*c]const u8, IncludePathLen: usize, APINotesFile: [*c]const u8, APINotesFileLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateNameSpace(Builder: LLVMDIBuilderRef, ParentScope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, ExportSymbols: LLVMBool) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateFunction(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, LinkageName: [*c]const u8, LinkageNameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, Ty: LLVMMetadataRef, IsLocalToUnit: LLVMBool, IsDefinition: LLVMBool, ScopeLine: c_uint, Flags: LLVMDIFlags, IsOptimized: LLVMBool) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateLexicalBlock(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, Column: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateLexicalBlockFile(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, File: LLVMMetadataRef, Discriminator: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateImportedModuleFromNamespace(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, NS: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateImportedModuleFromAlias(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, ImportedEntity: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, Elements: [*c]LLVMMetadataRef, NumElements: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateImportedModuleFromModule(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, M: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, Elements: [*c]LLVMMetadataRef, NumElements: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateImportedDeclaration(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Decl: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, Name: [*c]const u8, NameLen: usize, Elements: [*c]LLVMMetadataRef, NumElements: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateDebugLocation(Ctx: LLVMContextRef, Line: c_uint, Column: c_uint, Scope: LLVMMetadataRef, InlinedAt: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDILocationGetLine(Location: LLVMMetadataRef) c_uint;
pub extern fn LLVMDILocationGetColumn(Location: LLVMMetadataRef) c_uint;
pub extern fn LLVMDILocationGetScope(Location: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDILocationGetInlinedAt(Location: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIScopeGetFile(Scope: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIFileGetDirectory(File: LLVMMetadataRef, Len: [*c]c_uint) [*c]const u8;
pub extern fn LLVMDIFileGetFilename(File: LLVMMetadataRef, Len: [*c]c_uint) [*c]const u8;
pub extern fn LLVMDIFileGetSource(File: LLVMMetadataRef, Len: [*c]c_uint) [*c]const u8;
pub extern fn LLVMDIBuilderGetOrCreateTypeArray(Builder: LLVMDIBuilderRef, Data: [*c]LLVMMetadataRef, NumElements: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateSubroutineType(Builder: LLVMDIBuilderRef, File: LLVMMetadataRef, ParameterTypes: [*c]LLVMMetadataRef, NumParameterTypes: c_uint, Flags: LLVMDIFlags) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateMacro(Builder: LLVMDIBuilderRef, ParentMacroFile: LLVMMetadataRef, Line: c_uint, RecordType: LLVMDWARFMacinfoRecordType, Name: [*c]const u8, NameLen: usize, Value: [*c]const u8, ValueLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateTempMacroFile(Builder: LLVMDIBuilderRef, ParentMacroFile: LLVMMetadataRef, Line: c_uint, File: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateEnumerator(Builder: LLVMDIBuilderRef, Name: [*c]const u8, NameLen: usize, Value: i64, IsUnsigned: LLVMBool) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateEnumerationType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, SizeInBits: u64, AlignInBits: u32, Elements: [*c]LLVMMetadataRef, NumElements: c_uint, ClassTy: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateUnionType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, SizeInBits: u64, AlignInBits: u32, Flags: LLVMDIFlags, Elements: [*c]LLVMMetadataRef, NumElements: c_uint, RunTimeLang: c_uint, UniqueId: [*c]const u8, UniqueIdLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateArrayType(Builder: LLVMDIBuilderRef, Size: u64, AlignInBits: u32, Ty: LLVMMetadataRef, Subscripts: [*c]LLVMMetadataRef, NumSubscripts: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateVectorType(Builder: LLVMDIBuilderRef, Size: u64, AlignInBits: u32, Ty: LLVMMetadataRef, Subscripts: [*c]LLVMMetadataRef, NumSubscripts: c_uint) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateUnspecifiedType(Builder: LLVMDIBuilderRef, Name: [*c]const u8, NameLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateBasicType(Builder: LLVMDIBuilderRef, Name: [*c]const u8, NameLen: usize, SizeInBits: u64, Encoding: LLVMDWARFTypeEncoding, Flags: LLVMDIFlags) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreatePointerType(Builder: LLVMDIBuilderRef, PointeeTy: LLVMMetadataRef, SizeInBits: u64, AlignInBits: u32, AddressSpace: c_uint, Name: [*c]const u8, NameLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateStructType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, SizeInBits: u64, AlignInBits: u32, Flags: LLVMDIFlags, DerivedFrom: LLVMMetadataRef, Elements: [*c]LLVMMetadataRef, NumElements: c_uint, RunTimeLang: c_uint, VTableHolder: LLVMMetadataRef, UniqueId: [*c]const u8, UniqueIdLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateMemberType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, SizeInBits: u64, AlignInBits: u32, OffsetInBits: u64, Flags: LLVMDIFlags, Ty: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateStaticMemberType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, Type: LLVMMetadataRef, Flags: LLVMDIFlags, ConstantVal: LLVMValueRef, AlignInBits: u32) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateMemberPointerType(Builder: LLVMDIBuilderRef, PointeeType: LLVMMetadataRef, ClassType: LLVMMetadataRef, SizeInBits: u64, AlignInBits: u32, Flags: LLVMDIFlags) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateObjCIVar(Builder: LLVMDIBuilderRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, SizeInBits: u64, AlignInBits: u32, OffsetInBits: u64, Flags: LLVMDIFlags, Ty: LLVMMetadataRef, PropertyNode: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateObjCProperty(Builder: LLVMDIBuilderRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, GetterName: [*c]const u8, GetterNameLen: usize, SetterName: [*c]const u8, SetterNameLen: usize, PropertyAttributes: c_uint, Ty: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateObjectPointerType(Builder: LLVMDIBuilderRef, Type: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateQualifiedType(Builder: LLVMDIBuilderRef, Tag: c_uint, Type: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateReferenceType(Builder: LLVMDIBuilderRef, Tag: c_uint, Type: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateNullPtrType(Builder: LLVMDIBuilderRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateTypedef(Builder: LLVMDIBuilderRef, Type: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, Scope: LLVMMetadataRef, AlignInBits: u32) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateInheritance(Builder: LLVMDIBuilderRef, Ty: LLVMMetadataRef, BaseTy: LLVMMetadataRef, BaseOffset: u64, VBPtrOffset: u32, Flags: LLVMDIFlags) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateForwardDecl(Builder: LLVMDIBuilderRef, Tag: c_uint, Name: [*c]const u8, NameLen: usize, Scope: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, RuntimeLang: c_uint, SizeInBits: u64, AlignInBits: u32, UniqueIdentifier: [*c]const u8, UniqueIdentifierLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateReplaceableCompositeType(Builder: LLVMDIBuilderRef, Tag: c_uint, Name: [*c]const u8, NameLen: usize, Scope: LLVMMetadataRef, File: LLVMMetadataRef, Line: c_uint, RuntimeLang: c_uint, SizeInBits: u64, AlignInBits: u32, Flags: LLVMDIFlags, UniqueIdentifier: [*c]const u8, UniqueIdentifierLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateBitFieldMemberType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, SizeInBits: u64, OffsetInBits: u64, StorageOffsetInBits: u64, Flags: LLVMDIFlags, Type: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateClassType(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNumber: c_uint, SizeInBits: u64, AlignInBits: u32, OffsetInBits: u64, Flags: LLVMDIFlags, DerivedFrom: LLVMMetadataRef, Elements: [*c]LLVMMetadataRef, NumElements: c_uint, VTableHolder: LLVMMetadataRef, TemplateParamsNode: LLVMMetadataRef, UniqueIdentifier: [*c]const u8, UniqueIdentifierLen: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateArtificialType(Builder: LLVMDIBuilderRef, Type: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDITypeGetName(DType: LLVMMetadataRef, Length: [*c]usize) [*c]const u8;
pub extern fn LLVMDITypeGetSizeInBits(DType: LLVMMetadataRef) u64;
pub extern fn LLVMDITypeGetOffsetInBits(DType: LLVMMetadataRef) u64;
pub extern fn LLVMDITypeGetAlignInBits(DType: LLVMMetadataRef) u32;
pub extern fn LLVMDITypeGetLine(DType: LLVMMetadataRef) c_uint;
pub extern fn LLVMDITypeGetFlags(DType: LLVMMetadataRef) LLVMDIFlags;
pub extern fn LLVMDIBuilderGetOrCreateSubrange(Builder: LLVMDIBuilderRef, LowerBound: i64, Count: i64) LLVMMetadataRef;
pub extern fn LLVMDIBuilderGetOrCreateArray(Builder: LLVMDIBuilderRef, Data: [*c]LLVMMetadataRef, NumElements: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateExpression(Builder: LLVMDIBuilderRef, Addr: [*c]u64, Length: usize) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateConstantValueExpression(Builder: LLVMDIBuilderRef, Value: u64) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateGlobalVariableExpression(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, Linkage: [*c]const u8, LinkLen: usize, File: LLVMMetadataRef, LineNo: c_uint, Ty: LLVMMetadataRef, LocalToUnit: LLVMBool, Expr: LLVMMetadataRef, Decl: LLVMMetadataRef, AlignInBits: u32) LLVMMetadataRef;
pub extern fn LLVMGetDINodeTag(MD: LLVMMetadataRef) u16;
pub extern fn LLVMDIGlobalVariableExpressionGetVariable(GVE: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIGlobalVariableExpressionGetExpression(GVE: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIVariableGetFile(Var: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIVariableGetScope(Var: LLVMMetadataRef) LLVMMetadataRef;
pub extern fn LLVMDIVariableGetLine(Var: LLVMMetadataRef) c_uint;
pub extern fn LLVMTemporaryMDNode(Ctx: LLVMContextRef, Data: [*c]LLVMMetadataRef, NumElements: usize) LLVMMetadataRef;
pub extern fn LLVMDisposeTemporaryMDNode(TempNode: LLVMMetadataRef) void;
pub extern fn LLVMMetadataReplaceAllUsesWith(TempTargetMetadata: LLVMMetadataRef, Replacement: LLVMMetadataRef) void;
pub extern fn LLVMDIBuilderCreateTempGlobalVariableFwdDecl(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, Linkage: [*c]const u8, LnkLen: usize, File: LLVMMetadataRef, LineNo: c_uint, Ty: LLVMMetadataRef, LocalToUnit: LLVMBool, Decl: LLVMMetadataRef, AlignInBits: u32) LLVMMetadataRef;
pub extern fn LLVMDIBuilderInsertDeclareRecordBefore(Builder: LLVMDIBuilderRef, Storage: LLVMValueRef, VarInfo: LLVMMetadataRef, Expr: LLVMMetadataRef, DebugLoc: LLVMMetadataRef, Instr: LLVMValueRef) LLVMDbgRecordRef;
pub extern fn LLVMDIBuilderInsertDeclareRecordAtEnd(Builder: LLVMDIBuilderRef, Storage: LLVMValueRef, VarInfo: LLVMMetadataRef, Expr: LLVMMetadataRef, DebugLoc: LLVMMetadataRef, Block: LLVMBasicBlockRef) LLVMDbgRecordRef;
pub extern fn LLVMDIBuilderInsertDbgValueRecordBefore(Builder: LLVMDIBuilderRef, Val: LLVMValueRef, VarInfo: LLVMMetadataRef, Expr: LLVMMetadataRef, DebugLoc: LLVMMetadataRef, Instr: LLVMValueRef) LLVMDbgRecordRef;
pub extern fn LLVMDIBuilderInsertDbgValueRecordAtEnd(Builder: LLVMDIBuilderRef, Val: LLVMValueRef, VarInfo: LLVMMetadataRef, Expr: LLVMMetadataRef, DebugLoc: LLVMMetadataRef, Block: LLVMBasicBlockRef) LLVMDbgRecordRef;
pub extern fn LLVMDIBuilderCreateAutoVariable(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, File: LLVMMetadataRef, LineNo: c_uint, Ty: LLVMMetadataRef, AlwaysPreserve: LLVMBool, Flags: LLVMDIFlags, AlignInBits: u32) LLVMMetadataRef;
pub extern fn LLVMDIBuilderCreateParameterVariable(Builder: LLVMDIBuilderRef, Scope: LLVMMetadataRef, Name: [*c]const u8, NameLen: usize, ArgNo: c_uint, File: LLVMMetadataRef, LineNo: c_uint, Ty: LLVMMetadataRef, AlwaysPreserve: LLVMBool, Flags: LLVMDIFlags) LLVMMetadataRef;
pub extern fn LLVMGetSubprogram(Func: LLVMValueRef) LLVMMetadataRef;
pub extern fn LLVMSetSubprogram(Func: LLVMValueRef, SP: LLVMMetadataRef) void;
pub extern fn LLVMDISubprogramGetLine(Subprogram: LLVMMetadataRef) c_uint;
pub extern fn LLVMInstructionGetDebugLoc(Inst: LLVMValueRef) LLVMMetadataRef;
pub extern fn LLVMInstructionSetDebugLoc(Inst: LLVMValueRef, Loc: LLVMMetadataRef) void;
pub extern fn LLVMGetMetadataKind(Metadata: LLVMMetadataRef) LLVMMetadataKind;
