...
pub extern fn LLVMParseIRInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: [*c]LLVMModuleRef, OutMessage: [*c][*c]u8) LLVMBool;
