...
pub const struct_LLVMOpInfoSymbol1 = extern struct {
    Present: u64 = @import("std").mem.zeroes(u64),
    Name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    Value: u64 = @import("std").mem.zeroes(u64),
};
pub const struct_LLVMOpInfo1 = extern struct {
    AddSymbol: struct_LLVMOpInfoSymbol1 = @import("std").mem.zeroes(struct_LLVMOpInfoSymbol1),
    SubtractSymbol: struct_LLVMOpInfoSymbol1 = @import("std").mem.zeroes(struct_LLVMOpInfoSymbol1),
    Value: u64 = @import("std").mem.zeroes(u64),
    VariantKind: u64 = @import("std").mem.zeroes(u64),
};
pub const LLVMSymbolLookupCallback = ?*const fn (?*anyopaque, u64, [*c]u64, u64, [*c][*c]const u8) callconv(.c) [*c]const u8;
pub extern fn LLVMCreateDisasm(TripleName: [*c]const u8, DisInfo: ?*anyopaque, TagType: c_int, GetOpInfo: LLVMOpInfoCallback, SymbolLookUp: LLVMSymbolLookupCallback) LLVMDisasmContextRef;
pub extern fn LLVMCreateDisasmCPU(Triple: [*c]const u8, CPU: [*c]const u8, DisInfo: ?*anyopaque, TagType: c_int, GetOpInfo: LLVMOpInfoCallback, SymbolLookUp: LLVMSymbolLookupCallback) LLVMDisasmContextRef;
pub extern fn LLVMCreateDisasmCPUFeatures(Triple: [*c]const u8, CPU: [*c]const u8, Features: [*c]const u8, DisInfo: ?*anyopaque, TagType: c_int, GetOpInfo: LLVMOpInfoCallback, SymbolLookUp: LLVMSymbolLookupCallback) LLVMDisasmContextRef;
pub extern fn LLVMSetDisasmOptions(DC: LLVMDisasmContextRef, Options: u64) c_int;
pub extern fn LLVMDisasmDispose(DC: LLVMDisasmContextRef) void;
pub extern fn LLVMDisasmInstruction(DC: LLVMDisasmContextRef, Bytes: [*c]u8, BytesSize: u64, PC: u64, OutString: [*c]u8, OutStringSize: usize) usize;
...
pub const LLVM_C_DISASSEMBLER_H = "";
pub const LLVM_C_DISASSEMBLERTYPES_H = "";
...
pub const LLVMDisassembler_ReferenceType_In_ARM64_ADRP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000001, .hex);
pub const LLVMDisassembler_ReferenceType_In_ARM64_ADDXri = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000002, .hex);
pub const LLVMDisassembler_ReferenceType_In_ARM64_LDRXui = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000003, .hex);
pub const LLVMDisassembler_ReferenceType_In_ARM64_LDRXl = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000004, .hex);
pub const LLVMDisassembler_ReferenceType_In_ARM64_ADR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000005, .hex);
...
pub const LLVMOpInfoSymbol1 = struct_LLVMOpInfoSymbol1;
pub const LLVMOpInfo1 = struct_LLVMOpInfo1;
