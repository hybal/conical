...
pub const llvm_blake3_chunk_state = extern struct {
    cv: [8]u32 = @import("std").mem.zeroes([8]u32),
    chunk_counter: u64 = @import("std").mem.zeroes(u64),
    buf: [64]u8 = @import("std").mem.zeroes([64]u8),
    buf_len: u8 = @import("std").mem.zeroes(u8),
    blocks_compressed: u8 = @import("std").mem.zeroes(u8),
    flags: u8 = @import("std").mem.zeroes(u8),
};
pub const llvm_blake3_hasher = extern struct {
    key: [8]u32 = @import("std").mem.zeroes([8]u32),
    chunk: llvm_blake3_chunk_state = @import("std").mem.zeroes(llvm_blake3_chunk_state),
    cv_stack_len: u8 = @import("std").mem.zeroes(u8),
    cv_stack: [1760]u8 = @import("std").mem.zeroes([1760]u8),
};
...
pub const LLVM_BLAKE3_VERSION_STRING = "1.3.1";
pub const LLVM_BLAKE3_KEY_LEN = @as(c_int, 32);
pub const LLVM_BLAKE3_OUT_LEN = @as(c_int, 32);
pub const LLVM_BLAKE3_BLOCK_LEN = @as(c_int, 64);
pub const LLVM_BLAKE3_CHUNK_LEN = @as(c_int, 1024);
pub const LLVM_BLAKE3_MAX_DEPTH = @as(c_int, 54);
