...
pub extern fn LLVMParseBitcode(MemBuf: LLVMMemoryBufferRef, OutModule: [*c]LLVMModuleRef, OutMessage: [*c][*c]u8) LLVMBool;
pub extern fn LLVMParseBitcode2(MemBuf: LLVMMemoryBufferRef, OutModule: [*c]LLVMModuleRef) LLVMBool;
pub extern fn LLVMParseBitcodeInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutModule: [*c]LLVMModuleRef, OutMessage: [*c][*c]u8) LLVMBool;
pub extern fn LLVMParseBitcodeInContext2(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutModule: [*c]LLVMModuleRef) LLVMBool;
pub extern fn LLVMGetBitcodeModuleInContext(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: [*c]LLVMModuleRef, OutMessage: [*c][*c]u8) LLVMBool;
pub extern fn LLVMGetBitcodeModuleInContext2(ContextRef: LLVMContextRef, MemBuf: LLVMMemoryBufferRef, OutM: [*c]LLVMModuleRef) LLVMBool;
pub extern fn LLVMGetBitcodeModule(MemBuf: LLVMMemoryBufferRef, OutM: [*c]LLVMModuleRef, OutMessage: [*c][*c]u8) LLVMBool;
pub extern fn LLVMGetBitcodeModule2(MemBuf: LLVMMemoryBufferRef, OutM: [*c]LLVMModuleRef) LLVMBool;
