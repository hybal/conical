...
pub const struct_LLVMOpaqueSectionIterator = opaque {};
pub const LLVMSectionIteratorRef = ?*struct_LLVMOpaqueSectionIterator;
pub const struct_LLVMOpaqueSymbolIterator = opaque {};
pub const LLVMSymbolIteratorRef = ?*struct_LLVMOpaqueSymbolIterator;
pub const struct_LLVMOpaqueRelocationIterator = opaque {};
pub const LLVMRelocationIteratorRef = ?*struct_LLVMOpaqueRelocationIterator;
...
pub extern fn LLVMCreateBinary(MemBuf: LLVMMemoryBufferRef, Context: LLVMContextRef, ErrorMessage: [*c][*c]u8) LLVMBinaryRef;
pub extern fn LLVMDisposeBinary(BR: LLVMBinaryRef) void;
pub extern fn LLVMBinaryCopyMemoryBuffer(BR: LLVMBinaryRef) LLVMMemoryBufferRef;
pub extern fn LLVMBinaryGetType(BR: LLVMBinaryRef) LLVMBinaryType;
pub extern fn LLVMMachOUniversalBinaryCopyObjectForArch(BR: LLVMBinaryRef, Arch: [*c]const u8, ArchLen: usize, ErrorMessage: [*c][*c]u8) LLVMBinaryRef;
pub extern fn LLVMObjectFileCopySectionIterator(BR: LLVMBinaryRef) LLVMSectionIteratorRef;
pub extern fn LLVMObjectFileIsSectionIteratorAtEnd(BR: LLVMBinaryRef, SI: LLVMSectionIteratorRef) LLVMBool;
pub extern fn LLVMObjectFileCopySymbolIterator(BR: LLVMBinaryRef) LLVMSymbolIteratorRef;
pub extern fn LLVMObjectFileIsSymbolIteratorAtEnd(BR: LLVMBinaryRef, SI: LLVMSymbolIteratorRef) LLVMBool;
pub extern fn LLVMDisposeSectionIterator(SI: LLVMSectionIteratorRef) void;
pub extern fn LLVMMoveToNextSection(SI: LLVMSectionIteratorRef) void;
pub extern fn LLVMMoveToContainingSection(Sect: LLVMSectionIteratorRef, Sym: LLVMSymbolIteratorRef) void;
pub extern fn LLVMDisposeSymbolIterator(SI: LLVMSymbolIteratorRef) void;
pub extern fn LLVMMoveToNextSymbol(SI: LLVMSymbolIteratorRef) void;
pub extern fn LLVMGetSectionName(SI: LLVMSectionIteratorRef) [*c]const u8;
pub extern fn LLVMGetSectionSize(SI: LLVMSectionIteratorRef) u64;
pub extern fn LLVMGetSectionContents(SI: LLVMSectionIteratorRef) [*c]const u8;
pub extern fn LLVMGetSectionAddress(SI: LLVMSectionIteratorRef) u64;
pub extern fn LLVMGetSectionContainsSymbol(SI: LLVMSectionIteratorRef, Sym: LLVMSymbolIteratorRef) LLVMBool;
pub extern fn LLVMGetRelocations(Section: LLVMSectionIteratorRef) LLVMRelocationIteratorRef;
pub extern fn LLVMDisposeRelocationIterator(RI: LLVMRelocationIteratorRef) void;
pub extern fn LLVMIsRelocationIteratorAtEnd(Section: LLVMSectionIteratorRef, RI: LLVMRelocationIteratorRef) LLVMBool;
pub extern fn LLVMMoveToNextRelocation(RI: LLVMRelocationIteratorRef) void;
pub extern fn LLVMGetSymbolName(SI: LLVMSymbolIteratorRef) [*c]const u8;
pub extern fn LLVMGetSymbolAddress(SI: LLVMSymbolIteratorRef) u64;
pub extern fn LLVMGetSymbolSize(SI: LLVMSymbolIteratorRef) u64;
pub extern fn LLVMGetRelocationOffset(RI: LLVMRelocationIteratorRef) u64;
pub extern fn LLVMGetRelocationSymbol(RI: LLVMRelocationIteratorRef) LLVMSymbolIteratorRef;
pub extern fn LLVMGetRelocationType(RI: LLVMRelocationIteratorRef) u64;
pub extern fn LLVMGetRelocationTypeName(RI: LLVMRelocationIteratorRef) [*c]const u8;
pub extern fn LLVMGetRelocationValueString(RI: LLVMRelocationIteratorRef) [*c]const u8;
pub const struct_LLVMOpaqueObjectFile = opaque {};
pub const LLVMObjectFileRef = ?*struct_LLVMOpaqueObjectFile;
pub extern fn LLVMCreateObjectFile(MemBuf: LLVMMemoryBufferRef) LLVMObjectFileRef;
pub extern fn LLVMDisposeObjectFile(ObjectFile: LLVMObjectFileRef) void;
pub extern fn LLVMGetSections(ObjectFile: LLVMObjectFileRef) LLVMSectionIteratorRef;
pub extern fn LLVMIsSectionIteratorAtEnd(ObjectFile: LLVMObjectFileRef, SI: LLVMSectionIteratorRef) LLVMBool;
pub extern fn LLVMGetSymbols(ObjectFile: LLVMObjectFileRef) LLVMSymbolIteratorRef;
pub extern fn LLVMIsSymbolIteratorAtEnd(ObjectFile: LLVMObjectFileRef, SI: LLVMSymbolIteratorRef) LLVMBool;
...
pub const LLVM_NATIVE_ASMPARSER = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86AsmParser`");
// /usr/include/llvm/Config/llvm-config.h:37:9
pub const LLVM_NATIVE_ASMPRINTER = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86AsmPrinter`");
// /usr/include/llvm/Config/llvm-config.h:40:9
pub const LLVM_NATIVE_DISASSEMBLER = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86Disassembler`");
// /usr/include/llvm/Config/llvm-config.h:43:9
pub const LLVM_NATIVE_TARGET = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86Target`");
// /usr/include/llvm/Config/llvm-config.h:46:9
pub const LLVM_NATIVE_TARGETINFO = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86TargetInfo`");
// /usr/include/llvm/Config/llvm-config.h:49:9
pub const LLVM_NATIVE_TARGETMC = @compileError("unable to translate macro: undefined identifier `LLVMInitializeX86TargetMC`");
// /usr/include/llvm/Config/llvm-config.h:52:9
...
pub const LLVM_VERSION_MAJOR = @as(c_int, 19);
pub const LLVM_VERSION_MINOR = @as(c_int, 1);
pub const LLVM_VERSION_PATCH = @as(c_int, 7);
pub const LLVM_VERSION_STRING = "19.1.7";
...
pub const LLVMOpaqueSectionIterator = struct_LLVMOpaqueSectionIterator;
pub const LLVMOpaqueSymbolIterator = struct_LLVMOpaqueSymbolIterator;
pub const LLVMOpaqueRelocationIterator = struct_LLVMOpaqueRelocationIterator;
pub const LLVMOpaqueObjectFile = struct_LLVMOpaqueObjectFile;
