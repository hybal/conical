...
pub const struct_LLVMRemarkOpaqueString = opaque {};
pub const LLVMRemarkStringRef = ?*struct_LLVMRemarkOpaqueString;
...
pub const struct_LLVMRemarkOpaqueDebugLoc = opaque {};
pub const LLVMRemarkDebugLocRef = ?*struct_LLVMRemarkOpaqueDebugLoc;
...
pub const struct_LLVMRemarkOpaqueArg = opaque {};
pub const LLVMRemarkArgRef = ?*struct_LLVMRemarkOpaqueArg;
...
pub const struct_LLVMRemarkOpaqueEntry = opaque {};
pub const LLVMRemarkEntryRef = ?*struct_LLVMRemarkOpaqueEntry;
...
pub const struct_LLVMRemarkOpaqueParser = opaque {};
pub const LLVMRemarkParserRef = ?*struct_LLVMRemarkOpaqueParser;
...
pub extern fn LLVMRemarkParserHasError(Parser: LLVMRemarkParserRef) LLVMBool;
...
pub const REMARKS_API_VERSION = @as(c_int, 1);
...
pub const LLVMRemarkType = enum_LLVMRemarkType;
pub const LLVMRemarkOpaqueString = struct_LLVMRemarkOpaqueString;
pub const LLVMRemarkOpaqueDebugLoc = struct_LLVMRemarkOpaqueDebugLoc;
pub const LLVMRemarkOpaqueArg = struct_LLVMRemarkOpaqueArg;
pub const LLVMRemarkOpaqueEntry = struct_LLVMRemarkOpaqueEntry;
pub const LLVMRemarkOpaqueParser = struct_LLVMRemarkOpaqueParser;
