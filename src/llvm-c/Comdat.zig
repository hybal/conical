...
pub const LLVMAnyComdatSelectionKind: c_int = 0;
pub const LLVMExactMatchComdatSelectionKind: c_int = 1;
pub const LLVMLargestComdatSelectionKind: c_int = 2;
pub const LLVMNoDeduplicateComdatSelectionKind: c_int = 3;
pub const LLVMSameSizeComdatSelectionKind: c_int = 4;
pub const LLVMComdatSelectionKind = c_uint;
pub extern fn LLVMGetOrInsertComdat(M: LLVMModuleRef, Name: [*c]const u8) LLVMComdatRef;
pub extern fn LLVMGetComdat(V: LLVMValueRef) LLVMComdatRef;
pub extern fn LLVMSetComdat(V: LLVMValueRef, C: LLVMComdatRef) void;
pub extern fn LLVMGetComdatSelectionKind(C: LLVMComdatRef) LLVMComdatSelectionKind;
pub extern fn LLVMSetComdatSelectionKind(C: LLVMComdatRef, Kind: LLVMComdatSelectionKind) void;
