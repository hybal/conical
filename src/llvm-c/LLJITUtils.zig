...
pub const LLVMOrcCSymbolDependenceGroup = extern struct {
    Symbols: LLVMOrcCSymbolsList = @import("std").mem.zeroes(LLVMOrcCSymbolsList),
    Dependencies: LLVMOrcCDependenceMapPairs = @import("std").mem.zeroes(LLVMOrcCDependenceMapPairs),
    NumDependencies: usize = @import("std").mem.zeroes(usize),
};
...
pub extern fn LLVMOrcMaterializationResponsibilityNotifyEmitted(MR: LLVMOrcMaterializationResponsibilityRef, SymbolDepGroups: [*c]LLVMOrcCSymbolDependenceGroup, NumSymbolDepGroups: usize) LLVMErrorRef;
...
pub const LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction = ?*const fn (?*anyopaque, LLVMOrcExecutionSessionRef, [*c]const u8) callconv(.c) LLVMOrcObjectLayerRef;
pub const struct_LLVMOrcOpaqueLLJITBuilder = opaque {};
pub const LLVMOrcLLJITBuilderRef = ?*struct_LLVMOrcOpaqueLLJITBuilder;
pub const struct_LLVMOrcOpaqueLLJIT = opaque {};
pub const LLVMOrcLLJITRef = ?*struct_LLVMOrcOpaqueLLJIT;
pub extern fn LLVMOrcCreateLLJITBuilder() LLVMOrcLLJITBuilderRef;
pub extern fn LLVMOrcDisposeLLJITBuilder(Builder: LLVMOrcLLJITBuilderRef) void;
pub extern fn LLVMOrcLLJITBuilderSetJITTargetMachineBuilder(Builder: LLVMOrcLLJITBuilderRef, JTMB: LLVMOrcJITTargetMachineBuilderRef) void;
...
pub extern fn LLVMOrcCreateLLJIT(Result: [*c]LLVMOrcLLJITRef, Builder: LLVMOrcLLJITBuilderRef) LLVMErrorRef;
pub extern fn LLVMOrcDisposeLLJIT(J: LLVMOrcLLJITRef) LLVMErrorRef;
pub extern fn LLVMOrcLLJITGetExecutionSession(J: LLVMOrcLLJITRef) LLVMOrcExecutionSessionRef;
pub extern fn LLVMOrcLLJITGetMainJITDylib(J: LLVMOrcLLJITRef) LLVMOrcJITDylibRef;
...
pub extern fn LLVMOrcLLJITMangleAndIntern(J: LLVMOrcLLJITRef, UnmangledName: [*c]const u8) LLVMOrcSymbolStringPoolEntryRef;
pub extern fn LLVMOrcLLJITAddObjectFile(J: LLVMOrcLLJITRef, JD: LLVMOrcJITDylibRef, ObjBuffer: LLVMMemoryBufferRef) LLVMErrorRef;
pub extern fn LLVMOrcLLJITAddObjectFileWithRT(J: LLVMOrcLLJITRef, RT: LLVMOrcResourceTrackerRef, ObjBuffer: LLVMMemoryBufferRef) LLVMErrorRef;
pub extern fn LLVMOrcLLJITAddLLVMIRModule(J: LLVMOrcLLJITRef, JD: LLVMOrcJITDylibRef, TSM: LLVMOrcThreadSafeModuleRef) LLVMErrorRef;
pub extern fn LLVMOrcLLJITAddLLVMIRModuleWithRT(J: LLVMOrcLLJITRef, JD: LLVMOrcResourceTrackerRef, TSM: LLVMOrcThreadSafeModuleRef) LLVMErrorRef;
pub extern fn LLVMOrcLLJITLookup(J: LLVMOrcLLJITRef, Result: [*c]LLVMOrcExecutorAddress, Name: [*c]const u8) LLVMErrorRef;
pub extern fn LLVMOrcLLJITGetObjLinkingLayer(J: LLVMOrcLLJITRef) LLVMOrcObjectLayerRef;
pub extern fn LLVMOrcLLJITGetObjTransformLayer(J: LLVMOrcLLJITRef) LLVMOrcObjectTransformLayerRef;
pub extern fn LLVMOrcLLJITGetIRTransformLayer(J: LLVMOrcLLJITRef) LLVMOrcIRTransformLayerRef;
pub extern fn LLVMOrcLLJITGetDataLayoutStr(J: LLVMOrcLLJITRef) [*c]const u8;
pub extern fn LLVMOrcLLJITEnableDebugSupport(J: LLVMOrcLLJITRef) LLVMErrorRef;
...
pub const LLVM_C_LLJITUTILS_H = "";
pub const LLVM_C_LLJIT_H = "";
...
pub const LLVMOrcOpaqueLLJITBuilder = struct_LLVMOrcOpaqueLLJITBuilder;
pub const LLVMOrcOpaqueLLJIT = struct_LLVMOrcOpaqueLLJIT;
